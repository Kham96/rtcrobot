...
ROS2D.OccupancyGrid = function(options) {
  ...
  for ( var row = 0; row < this.height; row++) {
    for ( var col = 0; col < this.width; col++) {
      ...
      var rval, gval, bval, aval;
      var mapcolor = [// r g b a
        {r: 0  , g: 0  , b: 0  , a: 255},
        {r: 255, g: 255, b: 255, a: 255},
        {r: 127, g: 127, b: 127, a: 255}
      ];

      var costmapcolor = [// r g b a
        {r: 255, g: 45 , b:  45, a: 255},
        {r: 255, g: 255, b: 255, a:   0},
        {r:   0, g: 223, b: 255, a: 127}
      ];

      var rawcolor = [// r g b a
        {r:   0, g:   0, b:   0, a: 255},
        {r:   0, g:   0, b:   0, a:   0},
        {r: 127, g: 127, b: 127, a:  75}
      ];
      switch(color)
      {
        case 0:
        ...
        case 1:
            if (data === 100) {
              rval = costmapcolor[0].r;
              gval = costmapcolor[0].g;
              bval = costmapcolor[0].b;
              aval = costmapcolor[0].a;
            } else if (data === 0) {
              rval = costmapcolor[1].r;
              gval = costmapcolor[1].g;
              bval = costmapcolor[1].b;
              aval = costmapcolor[1].a;
            } else {
              rval = costmapcolor[2].r;
              gval = costmapcolor[2].g;
              bval = costmapcolor[2].b;
              aval = costmapcolor[2].a;
            }
          break;
        case 2:
            if (data === 100) {
      ...
      // r
      imageData.data[i] = rval;
      // g
      imageData.data[++i] = gval;
      // b
      imageData.data[++i] = bval;
      // a
      imageData.data[++i] = aval;
    }
  }
