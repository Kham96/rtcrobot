...
"""autogenerated by genpy from rtcrobot_actions/MissionAction.msg. Do not edit."""
import sys
...
class MissionAction(genpy.Message):
  _md5sum = "09e38efa4fd22c509f06eb9022786502"
  _type = "rtcrobot_actions/MissionAction"
...
"""
  ...
  _slot_types = ['rtcrobot_actions/MissionActionGoal','rtcrobot_actions/MissionActionResult','rtcrobot_actions/MissionActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = rtcrobot_actions.msg.MissionActionGoal()
      if self.action_result is None:
        self.action_result = rtcrobot_actions.msg.MissionActionResult()
      if self.action_feedback is None:
        self.action_feedback = rtcrobot_actions.msg.MissionActionFeedback()
    else:
      self.action_goal = rtcrobot_actions.msg.MissionActionGoal()
      self.action_result = rtcrobot_actions.msg.MissionActionResult()
      self.action_feedback = rtcrobot_actions.msg.MissionActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.action_goal.goal.command)
      buff.write(_struct_I.pack(length))
      for val1 in self.action_goal.goal.command:
        length = len(val1)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_feedback.feedback.mission_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.mission_id = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.mission_id = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.action_goal.goal.command = []
      for i in range(0, length):
        ...
        if python3:
          ...
          val1 = str[start:end]
        self.action_goal.goal.command.append(val1)
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.mission_name = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.mission_name = str[start:end]
      return self
