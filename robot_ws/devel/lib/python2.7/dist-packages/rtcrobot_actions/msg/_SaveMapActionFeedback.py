...
"""autogenerated by genpy from rtcrobot_actions/SaveMapActionFeedback.msg. Do not edit."""
import sys
...
class SaveMapActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "rtcrobot_actions/SaveMapActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','rtcrobot_actions/SaveMapFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SaveMapActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = rtcrobot_actions.msg.SaveMapFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = rtcrobot_actions.msg.SaveMapFeedback()
