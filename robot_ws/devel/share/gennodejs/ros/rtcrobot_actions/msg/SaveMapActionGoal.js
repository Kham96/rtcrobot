...
let SaveMapGoal = require('./SaveMapGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class SaveMapActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SaveMapGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += SaveMapGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SaveMapActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SaveMapGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SaveMapGoal()
    }
...
module.exports = SaveMapActionGoal;
